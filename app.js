...
const DailyReadings = require('./controllers/fetchDailyReadings').DailyReadings;
const fetchNewsFromCNA = require('./controllers/fetchNewsFromCNA');
const DailyReadingsJsonDB = require("./controllers/fetchDailyReadings").DailyReadingsJsonDB;
